#!/usr/bin/env python3
"""Extract text from a PDF page range as an OCR helper for visual reading."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract PDF text by page range.")
